classdef NamedConst
    ...
    properties (Constant)
        ...
        MAXIMUM_NUMBER_OF_CYCLES_PER_SIMULATION_LOOP = ...
            100 * NamedConst.CYCLE_FREQUENCY;
        ...
        RADAR_SCAN_CYCLE_TIME = ...
            NamedConst.CYCLE_FREQUENCY / NamedConst.RADAR_SCAN_FREQUENCY;

        % Radar Tracking Task Constants
        RADAR_TRACK_FREQUENCY = 4;
        RADAR_TRACK_CYCLE_TIME = ...
            NamedConst.CYCLE_FREQUENCY / NamedConst.RADAR_TRACK_FREQUENCY;

        % LPI Comms Tasks Constants
        COMMS_FREQUENCY = 2;
        COMMS_CYCLE_TIME = ...
            NamedConst.CYCLE_FREQUENCY / NamedConst.COMMS_FREQUENCY;
